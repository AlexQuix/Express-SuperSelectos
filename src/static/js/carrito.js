...
class Carrito{
    ...
    static addContentCarrito(json){
        ...
        contCarrito.innerHTML += `
                                <article id="${json["id"]}" class="product" data-index="${json["index"]}" data-price="${json["price"]}">
                                    <div id="inf-product">
                                        <div id="cont-img">
                                    ...
                                    <div class="btn-close" id="${json["id"]}">
